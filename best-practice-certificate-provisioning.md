...
If the server side generated key endpoint is supported the EST Server MUST perform client authentication as per [EST Server - Client Authentication](#est-server---client-authentication).
